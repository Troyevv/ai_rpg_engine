...
class RuntimeStorage:
    ...
    def update_motivation(self, save_id, actor_id, revision, short_goal, intentions):
        ...
        with self.connect() as db:
            ...
            state = edit_motivation(json.loads(row['state_json']), actor_id, short_goal, intentions)
            project(db, save_id, state)
